...
class Infobar
{
  ...
  public function get3() {
		$sql = "SELECT alarmLog.time, alarmLog.deviceWhich, alarms.alarmId, alarms.alarmDesc, alarms.alarmCause, alarms.alarmRemedy FROM alarmLog LEFT JOIN alarms ON alarmLog.alarmId = alarms.alarmId ORDER BY time DESC LIMIT 3;";
