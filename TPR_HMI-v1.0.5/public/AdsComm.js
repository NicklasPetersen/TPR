...
(function () {
  ...
  var NETID       = "192.168.56.1.1.1"; // Empty string for local machine;
  var PORT        = "851"; // PLC Runtime Twincat2 = 801 Twincat3 = 851
  var SERVICE_URL = "https://localhost/TcAdsWebService/TcAdsWebService.dll"; // HTTP path to the TcAdsWebService

  // Create Client (NULL, NULL) because there are no username and password
  ...
  var handlesVarNames = [
          "Global_Variables.stAdsTest.byteValue",
          "Global_Variables.stAdsTest.wordValue",
          "Global_Variables.stAdsTest.dwordValue",
          "Global_Variables.stAdsTest.sintValue",
          "Global_Variables.stAdsTest.intValue",
          "Global_Variables.stAdsTest.dintValue",
          "Global_Variables.stAdsTest.realValue",
          "Global_Variables.stAdsTest.lrealValue"
        ];
