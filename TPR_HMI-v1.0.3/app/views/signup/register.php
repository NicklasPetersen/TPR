...
<br><br><br>
		...
		<main>
			<form onsubmit="return isValidForm()" class="fifty" method="post" action="/public/user/">
				<?php
					if ($_SESSION['count'] > 0) {
				...
				<legend><h3>Sign up</h3></legend>
					...
					<img src="/app/views/partials/fejl.png" alt="error" id="everify">
					<br><br>
