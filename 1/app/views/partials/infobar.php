...
<div class="info-table">
  <div class="row" style=" border:1px solid #cbcbcb;">
    <p style="font-size: 4vw; width: 13%; display: inline-block; padding-left: 1em;">Time</p>
    <p style="font-size: 4vw; width: 13%; display: inline-block; padding-left: 1em;">Alarm</p>
    <p style="font-size: 4vw; width: 13%; display: inline-block; padding-left: 1em;">Description</p>
  </div>
  ...
  ?>
  <div class="row" style=" border:1px solid #cbcbcb;">
    <p style="font-size: 4vw; width: 13%; display: inline-block; padding-left: 1em;"><?= $alarm['time']?></p>
    <p style="font-size: 4vw; width: 13%; display: inline-block; padding-left: 1em;"><?= $alarm['alarmId']?></p>
    <p style="font-size: 4vw; width: 13%; display: inline-block; padding-left: 1em;"><?= $alarm['alarmDesc']?></p>
  </div>
