      ...
      <div class="container">
        <div class="logo">
          <a href="/tpr/public/user/">
            <img id="logo" src="/tpr/public/img/logo.png" href="pictures.php" alt="logo" title="">
          </a>
        </div>
          ...
          <nav>
           <div class="dropdown" id="down1">
            ...
            <ul class="dropdown-menu">
              <li><a href="/tpr/public/home/">          Main</a></li>
              ...
              <li><a href="/tpr/public/info/contact">   Information</a></li>
              <li><a href="/tpr/public/vision/control"> Vision control</a></li>
              <li><a href="/tpr/public/tool/control">   Tool control</a></li>
              <li class="divider"></li>
